...
| [usb4105-spec.pdf](datasheets/usb4105-spec.pdf) | GCT USB4105-GF-A USB-C receptacle datasheet — mid-mount, top-entry, SMD, used as J1 (power/data in). |
| [USBLC6-2SC6.pdf](datasheets/USBLC6-2SC6.pdf) | STMicroelectronics USBLC6-2SC6 dual-line USB ESD protection datasheet — SOT-23-6, 0.5pF/line, 5.25V clamp. Selected for D2 (USB D+/D- protection), replacing the bulk-only PRTR5V0U2X. Single device covers both lines. |
