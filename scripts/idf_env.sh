# Source this to set up the ESP-IDF 6.2 build environment.
# Generated from: python ~/esp/esp-idf/tools/activate.py --export --shell bash
# No secrets — all paths are local to this machine's IDF installation.
...
export IDF_TOOLS_INSTALL_CMD="/home/gm4ajk/esp/esp-idf/install.sh"
export IDF_TOOLS_EXPORT_CMD="/home/gm4ajk/esp/esp-idf/export.sh"
