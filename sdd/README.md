...
| [features/00010-StartSurveySession.html](features/00010-StartSurveySession.html) | Rover — Start Survey Session: filename (auto-suggested, FAT-safe), title (required), description (optional), SD card status; documents LOG_OPEN/LOG_RECORD/LOG_CLOSE/LOG_STATUS UART protocol additions (SD card on STM32F765, not ESP32) |
