# bno085-me-calibration

## Purpose

Provides BNO085 SH-2 command request/response support and the ME
calibration commands (Get/Set ME Calibration, Save DCD) used to query and
configure the sensor's motion-engine calibration behaviour and persist
