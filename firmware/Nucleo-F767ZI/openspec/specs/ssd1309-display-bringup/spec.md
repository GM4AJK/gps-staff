...
SSD1309 OLED panel I2C initialization and bring-up for the
Nucleo-F767ZI sandbox: bringing the panel up over I2C1 with the
correct power-on command sequence and proving the wiring/command
sequence with an all-pixels-on test pattern.
