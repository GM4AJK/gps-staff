...
Enable an SH-2 sensor report on the BNO085 by sending the SH-2 Set
Feature Command (report ID `0xFD`) on the SHTP control channel,
configuring its report interval, batch interval, change sensitivity, and
