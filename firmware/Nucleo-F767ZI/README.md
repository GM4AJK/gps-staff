...
| PB10 | USART3_TX → ST-LINK RX | VCP UART, MCU TX -> probe RX | CN10 pin 32 | CN3 Pin 2 |
| PD9  | USART3_RX ← ST-LINK TX | VCP UART, probe TX -> MCU RX | CN11 pin 67 | CN3 Pin 1 |

PA13/PA14/NRST are the MCU's native SWD pins. USART3_TX is on PB10
(CN10 pin 32) and USART3_RX is on PD9 (CN11 pin 67); both route through
to the external ST-LINK V3 VCP UART.
