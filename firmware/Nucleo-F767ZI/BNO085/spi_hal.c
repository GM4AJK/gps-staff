...
#define RSTN_PORT BNO085_RST_GPIO_Port
#define RSTN_PIN  BNO085_RST_Pin

//#define BOOTN_PORT GPIOB
//#define BOOTN_PIN  GPIO_PIN_5

#define PS0_WAKEN_PORT BNO085_PS0_WAKE_GPIO_Port
#define PS0_WAKEN_PIN  BNO085_PS0_WAKE_Pin

//#define PS1_PORT GPIOB
//#define PS1_PIN  GPIO_PIN_0

#define INTN_PORT BNO085_INT_GPIO_Port
#define INTN_PIN BNO085_INT_Pin

// CSN pin: B6
#define CSN_PORT BNO085_SPI_CS_GPIO_Port
#define CSN_PIN  BNO085_SPI_CS_Pin
