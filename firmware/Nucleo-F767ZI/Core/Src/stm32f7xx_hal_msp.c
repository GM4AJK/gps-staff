...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = BNO085_SPI_CLK_Pin|BNO085_SPI_MISO_Pin|BNO085_SPI_MOSI_Pin;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, BNO085_SPI_CLK_Pin|BNO085_SPI_MISO_Pin|BNO085_SPI_MOSI_Pin);
