...
int main(void)
{
  ...
  batteryTaskHandle = osThreadNew(task_battery, NULL, &batteryTask_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SX1262_SPI2_DIO2_GPIO_Port, SX1262_SPI2_DIO2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ESP32_GP1_Pin ESP32_GP2_Pin ESP32_GP3_Pin ESP32_GP4_Pin
                           ESP32_GP5_Pin MAGNETO_SPARE1_Pin MAGNETO_SPARE2_Pin F9P_SAFEBOOT_N_Pin
                           F9P_RESET_N_Pin F9P_D_SEL_Pin */
  GPIO_InitStruct.Pin = ESP32_GP1_Pin|ESP32_GP2_Pin|ESP32_GP3_Pin|ESP32_GP4_Pin
                          |ESP32_GP5_Pin|MAGNETO_SPARE1_Pin|MAGNETO_SPARE2_Pin|F9P_SAFEBOOT_N_Pin
                          |F9P_RESET_N_Pin|F9P_D_SEL_Pin;
  ...
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(F9P_ANT_DETECT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : F9P_ANT_OFF_Pin SX1262_RXEN_Pin SX1262T_XEN_Pin */
  GPIO_InitStruct.Pin = F9P_ANT_OFF_Pin|SX1262_RXEN_Pin|SX1262T_XEN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : F9P_ANT_SHORT_N_Pin SX1262_SPI2_DIO1_Pin */
  GPIO_InitStruct.Pin = F9P_ANT_SHORT_N_Pin|SX1262_SPI2_DIO1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : F9P_TIMEP_Pin F9P_EXTINT_Pin F9P_TX_READY_Pin */
  GPIO_InitStruct.Pin = F9P_TIMEP_Pin|F9P_EXTINT_Pin|F9P_TX_READY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : nPGOOD_Pin nCHG_Pin LSM6DSOX_INT1_Pin LSM6DSOX_INT2_Pin */
  GPIO_InitStruct.Pin = nPGOOD_Pin|nCHG_Pin|LSM6DSOX_INT1_Pin|LSM6DSOX_INT2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : SX1262_SPI2_CS_Pin SX1262_SPI2_RST_Pin */
  GPIO_InitStruct.Pin = SX1262_SPI2_CS_Pin|SX1262_SPI2_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : SX1262_SPI2_DIO2_Pin */
  GPIO_InitStruct.Pin = SX1262_SPI2_DIO2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SX1262_SPI2_DIO2_GPIO_Port, &GPIO_InitStruct);
