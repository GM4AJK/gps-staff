...
void app_main(void)
{
    ...
    lv_obj_t *password_entry = screen_password_entry_create(&theme_dark);
    ...
    screen_wifi_networks_set_nav_password(password_entry);
    screen_password_entry_set_nav_back(wifi_networks);
